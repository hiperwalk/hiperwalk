...
comando="python3 -m pip install -e $hwD --break-system-packages --no-build-isolation --config-settings editable_mode=compat"  # linux puro
comando="python3 -m pip install -e $hwD --break-system-packages --no-deps --no-cache"  # wsl
comando="python3 -m pip install -e $hwD --break-system-packages "  # wsl
