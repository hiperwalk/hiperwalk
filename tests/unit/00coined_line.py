...
class TestCoinedLine(unittest.TestCase):
    ...
    def Btest05_persistent_shift_right_state_transfer(self):
        # initial state in leftmost vertex
        # final state in rightmost vertex
        print("em test05_persistent_shift_left_state_transfer: inicio ")
        ...
        print("em test05_persistent_shift_left_state_transfer: final ")
